...
export default function DashboardPage() {
  const {
    pairs, pnl, positions, venues, alerts, fills, connected, engineConnected,
  } = useDashboard();
    ...
    <div className="flex flex-col h-screen">
      ...
      <main className="flex-1 overflow-auto p-4 bg-muted/30">
        <div className="grid grid-cols-12 gap-4">
          {/* Left column: PnL + Positions + Blotter */}
          <div className="col-span-3 flex flex-col gap-4">
            <PnlPanel pnl={pnl} />
            <PositionsGrid positions={positions} />
          </div>

          {/* Center-left: Prices + Blotter */}
          <div className="col-span-3 flex flex-col gap-4">
            <PriceTiles prices={pairs} />
            <TradeBlotter fills={fills} />
          </div>

          {/* Center-right: FV Monitor + Clients */}
          <div className="col-span-3 flex flex-col gap-4">
